 ...
 * (c) Adam Loboda 2021
 * 
 * This is ARDUINO PRO MINI version (ATMEGA328 based board)
 *
 */
...
/**
 * SPI pins for ATMEGA328 ( ARDUINO PRO MINI version )
 */

#define SPI_SS   B,2     // ATMEGA328 PB2 = SPI_SS , PRO MINI D10
#define SPI_MOSI B,3     // ATMEGA328 PB3 = MOSI ,   PRO MINI D11
#define SPI_MISO B,4     // ATMEGA328 PB4 = MISO ,   PRO MINI D12
#define SPI_SCK  B,5     // ATMEGA328 PB5 = SCK ,    PRO MINI D13
#define GDO0     D,2     // ATMEGA328 PD2 = INT0 ,   PRO MINI D2
...
#define PORT_GDO2  PINB  // ATMEGA328 PD2 = GDO2 , PRO MINI D9
#define BIT_GDO2  1
...
/**
 * select CC1101 by LOW SS signal - PORT B2
 */
...
/**
 * deselect CC1101 by HIGH SS signal - PORT B2
 */
...
/**
 * Wait until GDO0 line goes high - PORT D2
 */
...
/**
 * Wait until GDO0 line goes low - PORT D2
 */
